...
INSERT INTO `service`.`section` (`id`, `name`)
...
INSERT INTO `service`.`role` (`id`, `role`)
VALUES ('1', 'ROLE_USER');
INSERT INTO `service`.`role` (`id`, `role`)
VALUES ('2', 'ROLE_ADMIN');

INSERT INTO `service`.`profile` (`id`, `age`, `city`, `email`, `lastname`, `name`, `password`, `status`, `username`)
...
INSERT INTO `service`.`profile_role` (`role_id`, `client_id`)
VALUES ('1', '1');
INSERT INTO `service`.`profile_role` (`role_id`, `client_id`)
VALUES ('1', '2');
INSERT INTO `service`.`profile_role` (`role_id`, `client_id`)
...
INSERT INTO `service`.`comment` (`id`, `message`, `profile`)
VALUES ('1', 'all good', '1');
INSERT INTO `service`.`comment` (`id`, `message`, `profile`)
VALUES ('2', 'amazing', '2');
INSERT INTO `service`.`comment` (`id`, `message`, `profile`)
...
INSERT INTO `service`.`course` (`id`, `course_status`, `days`, `end_course`, `name`, `price`, `start_course`, `section`,
                                `speaker`)
...
INSERT INTO `service`.`course_profile` (`id_profile`, `id_course`)
VALUES ('1', '1');
INSERT INTO `service`.`course_profile` (`id_profile`, `id_course`)
VALUES ('2', '1');
INSERT INTO `service`.`course_profile` (`id_profile`, `id_course`)
...
INSERT INTO `service`.`course_comment` (`id_course`, id_comment)
VALUES ('4', '1');
INSERT INTO `service`.`course_comment` (`id_course`, id_comment)
VALUES ('4', '2');
INSERT INTO `service`.`course_comment` (`id_course`, id_comment)
...
INSERT INTO `service`.`lesson` (`id`, `duration`, `lesson_status`, `local_date_time`, `name`, `price`, `course`)
